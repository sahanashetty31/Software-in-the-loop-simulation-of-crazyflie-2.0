...
if __name__ == '__main__':
    ...
    cf.takeoff(targetHeight = 1.0, duration = 4.0)
    time.sleep(5.0)

    (t , x , y) = circle_trajectory(40 , 10 , 0.8)

    cf.goTo(goal = [0.5, 2.0, 0.5], yaw=0.0, duration = 4, relative = False)
  #  cf.goTo(goal = [1.0, 2.5, 0.0], yaw=0.0, duration = 4, relative = False)
  #  cf.goTo(goal = [2.0, 2.5, 0.0], yaw=0.0, duration = 4, relative = False)
  #  cf.goTo(goal = [1.0, 1.0, 0.0], yaw=0.0, duration = 4, relative = False)
  #  time.sleep(4)
